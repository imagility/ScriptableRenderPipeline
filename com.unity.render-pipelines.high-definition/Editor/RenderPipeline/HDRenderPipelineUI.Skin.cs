...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    static partial class HDRenderPipelineUI
    {
        ...
        static readonly GUIContent k_LutSize = EditorGUIUtility.TrTextContent("Grading LUT Size", "The size of the internal and external color grading lookup textures (LUTs).");
        static readonly GUIContent k_LutFormat = EditorGUIUtility.TrTextContent("Grading LUT Format", "The format to encode the color grading LUTs with. Lower precision formats are faster and use less memory at the expense of color precision.");
    }
}
